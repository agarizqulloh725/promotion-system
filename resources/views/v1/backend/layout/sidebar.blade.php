    ...
    <ul class="nav">
      <li class="nav-item nav-profile">
        <a href='/' class="nav-link">
          ...
          <div class="nav-profile-text d-flex flex-column">
            <span class="font-weight-bold mb-2 nameProfile"></span>
            <span class="text-secondary text-small roleUser"></span>
          </div>
      ...
      {{-- <li class="nav-item">
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item">
              <a class="nav-link" href={{asset('backend/pages/ui-features/buttons.html')}}>Buttons</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href={{asset('backend/pages/ui-features/dropdowns.html')}}>Dropdowns</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href={{asset('backend/pages/ui-features/typography.html')}}>Typography</a>
            </li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div class="collapse" id="icons">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item">
              <a class="nav-link" href={{asset('backend/pages/icons/font-awesome.html')}}>Font Awesome</a>
            </li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div class="collapse" id="forms">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item">
              <a class="nav-link" href={{asset('backend/pages/forms/basic_elements.html')}}>Form Elements</a>
            </li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href=pages/forms/basic_elements.html aria-expanded="false" aria-controls="charts">
        ...
        <div class="collapse" id="charts">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item">
              <a class="nav-link" href={{asset('backend/pages/charts/chartjs.html')}}>ChartJs</a>
            </li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div class="collapse" id="tables">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item">
              <a class="nav-link" href={{asset('backend/pages/tables/basic-table.html')}}>Basic table</a>
            </li>
          </ul>
        </div>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href={{asset('backend/docs/documentation.html')}} target="_blank">
