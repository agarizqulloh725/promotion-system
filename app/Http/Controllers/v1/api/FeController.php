...
class FeController extends Controller
{
    ...
    public function getProduct(Request $request) {
        try {
            ...
            // if (!empty($promos)) {
            //     $products->getCollection()->transform(function ($product) use ($promos) {
            //         if (!$product->promo) return null;
            //         $includeProduct = false;
            //         foreach ($promos as $promoType) {
            //             switch ($promoType) {
            //                 case 'Discount':
            //                     if (!empty($product->promo->discount)) $includeProduct = true;
            //                     break;
            //                 case 'Cashback':
            //                     if (!empty($product->promo->cashback)) $includeProduct = true;
            //                     break;
            //                 case 'Bonus':
            //                     if (!empty($product->promo->bonus)) $includeProduct = true;
            //                     break;
            //             }
            //         }
            //         return $includeProduct ? $product : null; 
            //     })->filter();
            // }
